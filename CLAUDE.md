...
- **提交信息使用英文** — 所有 commit message 必须使用英文
- **AI 协助时添加 Co-authored-by** — 若有 AI agent 协助完成变更，在提交信息末尾添加 `Co-authored-by: Cursor <cursoragent@cursor.com>`（或对应的 agent 身份）；不要添加 Made-with: Cursor 等
